...
import {
    ...
    dashcamWhiteBase64,
    telemetryBase64,
    telemetryWhiteBase64
} from '../assets/base64/imageStrings';
...
export const DRIVE_SAFE_BUNDLE_ITEMS = [
    {
        ...
        price: 59.99,
        image: telemetryBase64,
        color: '#000000',
        availableImages: {
            '#000000': telemetryBase64,
            '#FFFFFF': telemetryWhiteBase64
        }
    },
    {
        id: 2,
        ...
        color: '#000000',
        availableImages: {
            '#000000': dashcamBase64,
            '#FFFFFF': dashcamWhiteBase64
        }
    },
];
...
export const HEALTH_BUNDLE_ITEMS = [
    {
        ...
        price: 89.99,
        image: bloodPressureBase64,
        color: '#FFFFFF',
        availableImages: {
            '#FFFFFF': bloodPressureBase64,
            '#000000': telemetryBase64
        }
    },
    {
