...
export const DigitalWalletView: React.FC<DigitalWalletViewProps> = ({orderData, onPaymentAuthorized, currency}) => {
    return (
        <NoticeContainer>
            <IconWrapper>
                <Smartphone size={40}/>
            ...
            <GooglePayButton orderData={orderData} onPaymentAuthorized={onPaymentAuthorized} currency={currency}/>
        </NoticeContainer>
    );
};